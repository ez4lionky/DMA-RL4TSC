...
# when use CUDA, multi_process should be set to 0
set_GPU()
...
def parse_args():
    ...
    # parser.add_argument("-memo",       type=str,           default='benchmark_1001_8phases')
    parser.add_argument("-memo",       type=str,           default='benchmark_1001_4phases')

...
def summary_detail_RL(memo_rl, total_summary_rl):
    ...
    # records_dir = os.path.join("records", memo_rl, 'backup_action_interval_10_no_yellow')
    traffic_files = ['anon_3_4_jinan_real.json_03_03_21_32_01',
                     # 'EfficientColight_4phase_anon_3_4_jinan_real.json_01_06_19_59_11',
                     # 'EfficientMPLight_4phase_anon_3_4_jinan_real.json_01_06_19_59_13',
                     # 'EfficientPressLight_4phase_anon_3_4_jinan_real.json_01_06_19_59_18'
                     ]
    # Episodes 250 or 200
    ...
    for traffic_file in traffic_files:
        ...
        for round_rl in round_files:
            ...
            # drop the all flows that have NaN values (i.e. only calculate the flows that finished whole route)
            # nan_ids = df_vehicle_all[df_vehicle_all.isna().any(axis=1)]['vehicle_id']
            # df_vehicle_all = df_vehicle_all.loc[~df_vehicle_all['vehicle_id'].isin(nan_ids)]

...
if __name__ == '__main__':
    ...
    file_names = ["with_speed_score.log", "no_speed_score.log"]
    plot_labels = ["With speed score", "No speed score"]
    ...
    # metric_names = ['Average Travel Time', 'Average Speed Score', 'Average Throughput']
